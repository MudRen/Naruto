...
//        if( !channel_emote ) message("emote:vision", CYN + str + NOR, me);
        if( !channel_emote ) {
        	if( environment(me)->is_area() )
        		write( CYN + str + NOR );
//        		tell_area(environment(me), info["x_axis"], info["y_axis"], CYN + str + NOR, ({target}) );
...
//        if( !channel_emote ) message("emote:vision", CYN + str + NOR, target);
        if( !channel_emote ) {
        	if( environment(me)->is_area() )
        		tell_object(target, CYN + str + NOR );
//        		tell_area(environment(me), info["x_axis"], info["y_axis"], CYN + str + NOR, ({me}) );
...
//        if( !channel_emote ) message("emote:vision", CYN + str + NOR, environment(me), ({me, target}));
        if( !channel_emote ) {
        	if( environment(me)->is_area() )
        		tell_area(environment(me), info["x_axis"], info["y_axis"], CYN + str + NOR, ({me, target}) );
